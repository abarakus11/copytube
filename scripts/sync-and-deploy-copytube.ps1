# Commit + push automático do CopyTube para GitHub
...
$LogFile = Join-Path $Root '.cursor\hooks\deploy-copytube.log'
...
$msg = "Atualizacao automatica CopyTube - $(Get-Date -Format 'yyyy-MM-dd HH:mm')"
